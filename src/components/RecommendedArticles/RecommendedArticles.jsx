         ...
         {/* recommended articles*/}
          <div className="relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-2 gap-4 mt-8">
                <div style={game1Cover} className="sm:row-span-2 sm:col-span-2 bg-red-400 h-[350px] rounded-xl relative">
                  ...
                  <div className="absolute bottom-0 left-0 w-full">
                    <div className="flex justify-center items-center gap-4 bg-gradient-to-t from-primary to-transparent">
                      <div>
                        <img src={Game1} alt="" className="h-[140px]  min-w-[110px] object-cover rounded-xl"/>
                      </div>
                      <div>
                ...
                <div style={game3Cover} className="sm:row-span-1 bg-green-400 rounded-xl relative">
                <div className="bg-black/20 h-full w-full">

                <div className="absolute bottom-0 left-0 w-full">
                    <div className="flex justify-center items-center gap-4 bg-gradient-to-t from-primary to-transparent">
                      <div>
                        <img src={Game3} alt="" className="h-[100px]  min-w-[110px] object-cover rounded-xl"/>
                      </div>
                      <div>
                        <h1 className="font-semibold text-xl">Lorem ipsum dolor sit amet 
                          consectetur adipisicing elit. Deleniti</h1>
                      </div>
                    </div>
                  </div>
                  </div> 
